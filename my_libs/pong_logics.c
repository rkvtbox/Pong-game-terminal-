...
void ballControl(int *ball_x, int *ball_y, int *ball_direction, int racket_left,
  ...
  if (*ball_direction == -4 && *ball_x == 3 && *ball_y == racket_left) {
    *ball_direction = 5;
  } else if (*ball_direction == -4 && *ball_x == 3 &&
             *ball_y == racket_left - 1) {
    *ball_direction = 4;
  } else if (*ball_direction == -4 && *ball_x == 3 &&
             *ball_y == racket_left - 2) {
  ...
  if (*ball_direction == -2 && *ball_x == 3 && *ball_y == racket_left) {
    *ball_direction = 1;
  } else if (*ball_direction == -2 && *ball_x == 3 &&
             *ball_y == racket_left - 1) {
    *ball_direction = 2;
  } else if (*ball_direction == -2 && *ball_x == 3 &&
             *ball_y == racket_left - 2) {
  ...
  if (*ball_direction == 4 && *ball_x == 79 && *ball_y == racket_right) {
    *ball_direction = -5;
  } else if (*ball_direction == 4 && *ball_x == 79 &&
             *ball_y == racket_right - 1) {
    *ball_direction = -4;
  } else if (*ball_direction == 4 && *ball_x == 79 &&
             *ball_y == racket_right - 2) {
  ...
  if (*ball_direction == 2 && *ball_x == 79 && *ball_y == racket_right) {
    *ball_direction = -1;
  } else if (*ball_direction == 2 && *ball_x == 79 &&
             *ball_y == racket_right - 1) {
    *ball_direction = -2;
  } else if (*ball_direction == 2 && *ball_x == 79 &&
             *ball_y == racket_right - 2) {
